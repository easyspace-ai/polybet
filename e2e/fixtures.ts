...
const API_BASE = process.env.NEXT_PUBLIC_API_URL || `http://localhost:${process.env.PORT || "7655"}`;
const DATABASE_URL = process.env.DATABASE_URL ?? "postgres://polybet:polybet@localhost:5432/polybet?sslmode=disable";
