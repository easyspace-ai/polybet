...
import type { Issue, IssueStatus, IssuePriority, IssueAssigneeType } from "@polybet/core/types";
import {
  DialogContent,
  DialogTitle,
...
import { useCreateIssue, useUpdateIssue } from "@polybet/core/issues/mutations";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const shouldShowBacklogHint =
        ...
        localStorage.getItem("polybet:backlog-agent-hint-dismissed") !== "true";
        ...
        {backlogHintIssueId ? (
          <BacklogAgentHintContent
            ...
            onDismissPermanently={() => {
              localStorage.setItem("polybet:backlog-agent-hint-dismissed", "true");
            }}
            onMoveToTodo={() => {
...
import { Dialog as DialogRoot } from "@polybet/ui/components/ui/dialog";
