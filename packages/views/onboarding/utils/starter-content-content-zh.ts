...
export function buildWelcomeIssueText(
  ...
  const header = [
    ...
    ``,
    `[了解 Multica 是怎么运转的 →](https://polybet.ai/docs/zh/how-polybet-works)`,
    ``,
    `---`,
    ``,
  ].join("\n");
...
export function buildAgentGuidedSubIssues(
  ...
  const tier1: ImportStarterIssuePayload[] = [
    {
      ...
      description: [
        ...
        ``,
        `[关于把 issue 分配给智能体 →](https://polybet.ai/docs/zh/assigning-issues)`,
      ].join("\n"),
    },
    {
      status: "todo",
      ...
      description: [
        ...
        ``,
        `[关于聊天 →](https://polybet.ai/docs/zh/chat)`,
      ].join("\n"),
    },
    {
      status: "todo",
      ...
      description: [
        ...
        ``,
        `[关于工作区 →](https://polybet.ai/docs/zh/workspaces)`,
      ].join("\n"),
    },
  ];
  ...
  if (q.team_size === "team") {
    tier2.push({
      ...
      description: [
        ...
        ``,
        `[关于成员与角色 →](https://polybet.ai/docs/zh/members-roles)`,
      ].join("\n"),
    });
  }
  ...
  tier2.push({
    ...
    description: [
      ...
      ``,
      `[关于创建智能体 →](https://polybet.ai/docs/zh/agents-create)`,
    ].join("\n"),
  });
  ...
  const tier3: ImportStarterIssuePayload[] = [
    ...
    },
    {
      ...
      description: [
        ...
        ``,
        `[关于执行任务 →](https://polybet.ai/docs/zh/tasks)`,
      ].join("\n"),
    },
    {
      status: "backlog",
      ...
      description: [
        ...
        ``,
        `[关于收件箱 →](https://polybet.ai/docs/zh/inbox)`,
      ].join("\n"),
    },
    {
      status: "backlog",
      ...
      description: [
        ...
        ``,
        `[关于自动化 →](https://polybet.ai/docs/zh/autopilots)`,
      ].join("\n"),
    },
  ];
  ...
  const tier1: ImportStarterIssuePayload[] = [
    {
      ...
      description: [
        ...
        `1. 去 [github.com/polybet-ai/polybet/releases/latest](https://github.com/polybet-ai/polybet/releases/latest) 下载 macOS 的 \`.dmg\``,
        `2. 安装并打开`,
        ...
        ``,
        `[关于守护进程与运行时 →](https://polybet.ai/docs/zh/daemon-runtimes)`,
      ].join("\n"),
    },
    {
      status: "todo",
