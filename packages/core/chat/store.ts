...
const AGENT_STORAGE_KEY = "polybet:chat:selectedAgentId";
const SESSION_STORAGE_KEY = "polybet:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "polybet:chat:drafts";
/** Placeholder sessionId for a chat that hasn't been created yet. */
export const DRAFT_NEW_SESSION = "__new__";
const CHAT_WIDTH_KEY = "polybet:chat:width";
const CHAT_HEIGHT_KEY = "polybet:chat:height";
const CHAT_EXPANDED_KEY = "polybet:chat:expanded";
/** Focus mode is a personal preference — global across workspaces/sessions. */
const FOCUS_MODE_KEY = "polybet:chat:focusMode";
/**
 ...
 */
const OPEN_KEY = "polybet:chat:isOpen";
