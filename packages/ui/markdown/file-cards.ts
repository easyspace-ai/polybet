 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "polybet-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "polybet-static.copilothub.ai")
 */
